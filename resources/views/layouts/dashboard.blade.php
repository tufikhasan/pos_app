                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    ...
                    <div id="dropdownProfile"
                        ...
                        <div class="profilename">
                            ...
                            <hr class="!m-0">
                            <a class="dropdown-item" href="profile.html"> <i class="mr-2" data-feather="user"></i>
                                My Profile</a>
                                ...
                                <div class="graph-sets">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                            id="dropdownMenuButton" data-dropdown-toggle="dropdownChart"
                                            aria-expanded="false">
                                            2022 <img src="assets/img/icons/dropdown.svg" alt="img"
                                                class="ml-2">
                                        </button>
                                        <ul id="dropdownChart"
                                            class="hidden dropdown-menu !translate-x-0 !top-9 !left-0"
                    ...
                    <div class="col-span-5">
                        <div class="card flex-auto">
                            <div class="card-header !pb-0 flex justify-between items-center">
                                ...
                                <div class="dropdown">
                                    <a href="javascript:void(0);" data-dropdown-toggle="dropdownPdt"
                                        aria-expanded="false" class="dropset">
                                        <i class="fa fa-ellipsis-v"></i>
                                    </a>
                                    <ul id="dropdownPdt"
                                        class="hidden dropdown-menu !inset-auto !translate-x-0 !top-9 !right-0"
                                        aria-labelledby="dropdownMenuButton">
                                        <li>
