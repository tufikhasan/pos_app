...
@section('site_title', 'Brands Management')
@section('content')
    <div class="row mt-4">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <button class="btn btn-icon btn-primary" type="button" data-toggle="modal"
                            ...
                            <span class="btn-inner--text">Add New Brand</span>
                        </button>
                    </div>
    ...
    @include('pages.brands.add')
    @include('pages.brands.edit')
    @include('pages.brands.delete')
@endsection
@section('script')
    @include('pages.brands.script')
@endsection
