    ...
    <div class="flex items-center justify-center h-screen px-4 text-center sm:block sm:p-0 w-auto">
        ...
        <form id="delete_product_form"
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <p class="text-center">Are you sure want to delete this product. Click 'Confirm' to <br> proceed with
                    the deletion
                    or
                    'Cancel' to abort</p>
            </div>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse">
                ...
                <button onclick="hiddenModal('delete_product_modal')" type="button" class="btn btn-danger ml-1">
                    Cancel
                </button>
            </div>
        </form>
