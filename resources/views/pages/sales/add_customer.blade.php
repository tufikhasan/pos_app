<!-- Modal -->
<div class="modal fade" id="add_cus_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" id="add_cus_form">
            <div class="modal-header">
                <h5 class="modal-title">Add New customer</h5>
                <button type="button" class="close" onclick="closeModal('#add_cus_modal','add_cus_form')">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
                    onclick="closeModal('#add_cus_modal','add_cus_form')">Close</button>
